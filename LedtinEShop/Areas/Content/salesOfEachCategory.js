...
function drawChart() {
    $.ajax({
        type: "POST",
        url: "/Admin/Report/SalesOfEachCategoryJS",
        data: '{}',
        ...
        success: function (data) {
            ...
            var optionsQuantity = {
                title: 'Quantity Sales Of Each Category',
                height: 400,
                bar: { groupWidth: "100%" },
                legend: { position: "none" },
            };

            var chart = new google.visualization.ColumnChart($("#quantitySalesOfEachCategoryChart")[0]);
            ...
            var optionsQuantityPercent = {
                title: "Quantity Sales Percent Of Each Category",
                position: "none",
                is3D: true,
                fontsize: "100px",
            };
            var chart = new google.visualization.PieChart(document.getElementById('quantitySalesOfEachCategoryPieChart'));
